...
void exception0_handler(exception_stack_frame_t *stack_frame)
{
...
void exception3_handler(exception_stack_frame_t *stack_frame)
{
...
void exception6_handler(exception_stack_frame_t *stack_frame)
{
...
void exception8_handler(exception_stack_frame_t *stack_frame,
...
void exception14_handler(exception_stack_frame_t *stack_frame,
			 uint64_t error_code)
{
